...
xtabs(~Species, Species_new, data = my.iris)
...
my.iris$specis_relevel = relevel(my.iris$Species, "setosa") #just sets the reference level
summary(my.iris)
...
my.iris$specis_reorder = reorder(my.iris$Species, my.iris$SpeciesNewNum) #reordering Species (but not saving                                                             that change, based on the numberes in that column)
